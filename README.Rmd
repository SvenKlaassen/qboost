...
Documentation of functions in R: [Documentation](https://svenklaassen.github.io/qboost/)

**qboost** is currently maintained by [`@SvenKlaassen`](https://github.com/SvenKlaassen).
